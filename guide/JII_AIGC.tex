...
% \affiliation{organization={Queen's University},
%             addressline={99 University Ave}, 
%             city={Kingston},
%             postcode={K7L 3N6}, 
%             state={ON},
%             country={Canada}}
...
\bibitem[Achiam et al.(2023)]{gpt4}
  Achiam, J., et al.,
...
\bibitem[Brooks et al.(2024)]{sora}
  Brooks, T., et al.,
  Video Generation Models as World Simulators,
  OpenAI Technical Report, 2024.

\bibitem[Zou et al.(2023)]{gcg}
  Zou, A., et al.,
  Universal and Transferable Adversarial Attacks on Aligned Language Models,
  arXiv:2307.15043, 2023.

\bibitem[Greshake et al.(2023)]{ipi}
  Greshake, K., et al.,
  Not What You've Signed Up For: Compromising Real-World LLM-Integrated Applications with Indirect Prompt Injection,
  AISec, 2023.

\bibitem[Carlini et al.(2024)]{poisoning}
  Carlini, N., et al.,
  Poisoning Web-Scale Training Datasets is Practical,
  IEEE S\&P, 2024.

\bibitem[Shumailov et al.(2024)]{modelcollapse}
  Shumailov, I., et al.,
...
\bibitem[Unit42(2025)]{unit42ipi}
  Palo Alto Networks Unit 42,
  Fooling AI Agents: Web-Based Indirect Prompt Injection Observed in the Wild,
  2025.

\bibitem[Elastic Security Labs(2025)]{elasticmcp}
  Elastic Security Labs,
  MCP Tools: Attack Vectors and Defense Recommendations for Autonomous Agents,
  2025.

\bibitem[EU(2024)]{euaiact}
  European Parliament,
  Regulation (EU) 2024/1689 (EU AI Act),
  Official Journal of the EU, 2024.

\bibitem[Bengio et al.(2025)]{aisafetyreport2025}
  Bengio, Y., et al.,
  International AI Safety Report,
  DSIT 2025/001, 2025.

\bibitem[Bengio et al.(2026)]{aisafetyreport2026}
  Bengio, Y., et al.,
  International AI Safety Report 2026,
  DSIT, 2026.

\bibitem[Mitchell et al.(2023)]{detectgpt}
  Mitchell, E., et al.,
  DetectGPT: Zero-Shot Machine-Generated Text Detection using Probability Curvature,
  ICML, 2023.

\bibitem[R{\"o}ssler et al.(2019)]{faceforensics}
  R{\"o}ssler, A., et al.,
  FaceForensics++: Learning to Detect Manipulated Facial Images,
  ICCV, 2019.

\bibitem[Kirchenbauer et al.(2023)]{kgw}
  Kirchenbauer, J., et al.,
  A Watermark for Large Language Models,
  ICML, 2023.

\bibitem[Fernandez et al.(2023)]{stablesig}
  Fernandez, P., et al.,
  The Stable Signature: Rooting Watermarks in Latent Diffusion Models,
  ICCV, 2023.

\bibitem[Wen et al.(2023)]{treering}
  Wen, Y., et al.,
  Tree-Ring Watermarks: Fingerprints for Diffusion Images that are Invisible and Robust,
  NeurIPS, 2023.

\bibitem[Ouyang et al.(2022)]{rlhf}
  Ouyang, L., et al.,
...
\bibitem[Bai et al.(2022)]{constitutionalai}
  Bai, Y., et al.,
  Constitutional AI: Harmlessness from AI Feedback,
  arXiv:2212.08073, 2022.

\bibitem[OpenAI(2025)]{openaiipi}
  OpenAI,
