...
This structural vulnerability is compounded by a \emph{temporal gap} between capability deployment and defensive response. MCP shipped without authentication (November 2024); the first tool-poisoning study appeared five months later (April 2025)~\cite{invariant2025toolpoisoning}; OAuth 2.1 was retrofitted in March 2025~\cite{mcpspec2025}; the first cryptographic defense (ETDI) was proposed in June 2025~\cite{bhatt2025etdi}; and the first government-level agentic governance framework appeared in January 2026~\cite{imda2026agentic}---a 14-month gap from deployment to governance. This pattern of ``deploy first, retrofit security later'' recurs throughout the AIGC ecosystem and is formalized in Section~\ref{sec:conclusions} as the \emph{temporal misalignment} meta-pattern.
