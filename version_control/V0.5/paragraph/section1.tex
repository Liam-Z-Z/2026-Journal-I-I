...
\begin{enumerate}[nosep,leftmargin=1.5em]
    ...
    \item \textbf{Cross-disciplinary analysis bridging technology and policy.} We bridge technical countermeasures (Section~\ref{sec:countermeasures}) with governance frameworks across the EU, US, and China (Section~\ref{sec:governance}).
