...
\begin{enumerate}[nosep,leftmargin=1.5em]
    \item \textbf{Formal agent trust models.} No mathematically complete trust calculus exists for composing trust across delegation chains. \emph{Open problem:} dynamic trust revocation with provable guarantees under adversarial conditions~\cite{trustparadox2025}.
...
Three methodological boundaries should be noted. \emph{Scope and selection:} this survey prioritizes breadth across the content-to-action spectrum over exhaustive depth in any single subfield; federated learning security, synthetic data pipelines, and detailed red-teaming methodology each merit dedicated treatment and are excluded by design rather than oversight. \emph{Data provenance:} as noted in Section~\ref{sec:threats}, several key statistics originate from industry reports with undisclosed methodologies; we flag these at each citation and treat them as trend indicators rather than precise measurements. \emph{Temporal scope:} the knowledge cutoff of March 2026 makes this survey among the most current available, but the field evolves on monthly timescales---particularly the agentic security literature (predominantly 2025--2026), which is too young for confident long-term trend extrapolation.
